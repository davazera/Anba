...
<p>Detta är min me-sida för kursen oophp och mitt namn är Anton Backe och jag är 21 år 
   ...
   , anledningen är att jag efter 3 år in i programmet känner att jag saknar vissa 
   programmeringskunskaper, speciellt med koppling mot databaser. De kurser som vi faktiskt
    har läst har enbart fokuserat på C# där uppgifterna har varit, minst sagt, omotiverade.</p>
...
<p>Förutom att jag studerar 125% för närvarande så arbetar jag även deltid på Nordea och 
   försöker, så gott det går, att träna på den fritid som blir över. Mitt mål för tillfället
    är väl att vidareutveckla mina kunskaper för att i framtiden nischa in mig på området 
    systemutveckling med inriktning åt banksäkerhet.</p>

<p>Jag har alltid varit intresserad av teknik och mer precist, datorer. Jag antar att det 
...
<p>Avslutningsvis vill jag bara säga att jag har stora förhoppningar på kursen och att det
	jag sett hittils verkar stämma överens med de förväntningar jag har. </p>
